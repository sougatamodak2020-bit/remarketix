...
import {
  Check, ArrowRight, Zap, Clock, Briefcase, Target,
  Search, Database, Mail, FileText, Building2, 
  Link as LinkIcon, Send, BarChart2, Globe, Code, Megaphone,
  Sparkles, Crown, ChevronLeft, ChevronRight, Layers
} from "lucide-react";

// Icon mapping
const ICONS: Record<string, React.ElementType> = {
  Clock, Briefcase, Target, Search, Database, Mail, FileText, 
  Building2, Linkedin: LinkIcon, Send, BarChart2, Globe, Code, Megaphone, Sparkles
};
    ...
    services: [
      {
        ...
        icon: "Search",
        description: "Targeted lead databases built based on your ideal customer profile.",
        features: [
          "B2B lead generation",
      ...
      },
      {
        ...
        icon: "Database",
        description: "Structured and customized data collected from reliable sources.",
        features: [
      ...
      },
      {
        ...
        icon: "Mail",
        description: "Clean and deliverable email databases for outreach campaigns.",
        features: [
          "Email discovery",
      ...
      },
      {
        ...
        icon: "FileText",
        description: "Organized and accurate data management for your CRM systems.",
        features: [
      ...
      },
      {
        ...
        icon: "Database",
        description: "Collection of structured data from public and online sources.",
        features: [
          "Web data collection",
      ...
      },
      {
        ...
        icon: "Building2",
        description: "Detailed insights about target companies and decision-makers.",
        features: [
          "Company analysis",
          "Market insights",
    ...
    services: [
      {
        ...
        icon: "Linkedin",
        description: "Personalized LinkedIn campaigns to generate leads and conversations.",
        features: [
          "Prospect targeting",
          "Message sequences",
      ...
      },
      {
        ...
        icon: "Mail",
        description: "Conversion-focused email campaigns designed to generate responses.",
        features: [
          "Campaign setup",
          "Copywriting",
    ...
    services: [
      {
        ...
        icon: "Linkedin",
        description: "Optimize your profile and build authority through consistent content.",
        features: [
      ...
      },
      {
        ...
        icon: "BarChart2",
        description: "Improve visibility and drive organic growth through optimized content.",
        features: [
          "Keyword research",
          "Content creation",
          "SEO optimization"
    ...
    services: [
      {
        ...
        icon: "Code",
        description: "Conversion-focused websites and user-friendly digital experiences.",
        features: [
          "UI and UX design",
          "Website development",
          "Responsive design"
      ...
      },
      {
        ...
        icon: "Megaphone",
        description: "Creative and performance-driven campaigns to promote your product.",
        features: [
          "Ad strategy",
        ...
        {!shouldReduceMotion && (
          <>
            ...
            <motion.div
              ...
              style={{ 
                background: "radial-gradient(ellipse 50% 50% at 50% 50%, rgba(59, 130, 246, 0.12), transparent 70%)", 
                filter: "blur(80px)" 
              }}
      ...
      <div className="relative z-10 container-custom section-spacing px-4 md:px-6 pt-32">
        ...
        >
          ...
          <h1 className="heading-display mb-5 md:mb-6">
            ...
            <span className="block gradient-text-enhanced mt-2 md:mt-3">Built for Scale</span>
          </h1>
          <motion.div
          ...
          <p className="text-body-lg mb-8 md:mb-10 text-white/80 px-4 md:px-0">
            Flexible plans designed for businesses of all sizes. Pay only for what you need.
          </p>
                  ...
                  >
                    ...
                    >
                      ...
                      <motion.button
                        ...
                        className={`${
                          isFeatured ? "btn-primary-premium" : "btn-secondary-premium"
        ...
        {SERVICE_CATEGORIES.map((category, categoryIndex) => {
          ...
          return (
            <div key={category.id} className="mb-20 md:mb-28">
              <motion.div
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                {category.services.map((service: Service, serviceIndex) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        <p className="text-sm text-white/60 mb-5 md:mb-6">
                          {service.description}
                        </p>
              ...
              {categoryIndex < SERVICE_CATEGORIES.length - 1 && (
                <div className="divider-glow my-16 md:my-24" />
              )}
            </div>
          );
        })}
        ...
        >
          ...
          <p className="text-body-lg max-w-2xl mx-auto mb-8 md:mb-10 text-white/80 px-4 md:px-0">
            We create customized solutions based on your business goals, target market and required services.
          </p>
