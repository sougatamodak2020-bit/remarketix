...
const testimonials = [
  ...
  {
    quote: "Fast, reliable, and highly accurate data for our campaigns.",
...
function TestimonialCard({ t }: { t: typeof testimonials[0] }) {
  return (
    <div className="testimonial-card flex flex-col h-full p-6 md:p-8 rounded-2xl md:rounded-3xl bg-white/[0.03] border border-white/10 relative overflow-hidden group">
      <div
        className={`absolute -inset-1 bg-gradient-to-r from-${t.color}-500/20 to-transparent rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-xl`}
      />
    ...
    <div className="flex flex-col min-h-screen">
        ...
        <div className="container-custom relative z-10 text-center px-4">
          ...
          >
            ...
            <p className="text-body-lg max-w-2xl mx-auto text-white/80 px-4 md:px-0">
              Real feedback from businesses we&apos;ve helped achieve their
              goals.
            </p>
          </motion.div>
        </div>
      ...
      <section className="section-spacing pt-0">
        <div className="container-custom px-4">
          {/* Mobile: Native CSS Snap Scroll (Much smoother than JS) */}
              ...
              >
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <h3
                      className={`font-semibold text-white group-hover:text-${sector.color}-400 transition-colors text-sm md:text-base`}
                    >
                      {sector.label}
                    </h3>
                  </div>
        ...
        <div className="container-custom px-4 md:px-6">
          ...
          >
            ...
            <p className="text-body-lg max-w-2xl mx-auto mb-8 md:mb-10 text-white/80">
              Join hundreds of businesses that turned their data challenges into
